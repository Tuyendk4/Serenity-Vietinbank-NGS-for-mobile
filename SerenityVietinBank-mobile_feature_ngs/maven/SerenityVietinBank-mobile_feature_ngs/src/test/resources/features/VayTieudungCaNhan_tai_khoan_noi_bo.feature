...
Tính năng: M7S01 - Vay tiêu dùng cá nhân
  ...
  Kịch bản: Thực hiện vay tiêu dùng bằng tài khoản nội bộ cachua
    Cho Mở VTB iPayApp
    Khi Đăng nhập user "cachua", password "12121212"
    ...
    * MH Vay - Bước 1 - Số tiền phải trả hàng tháng mặc định "Từ 251,083 VND đến 263,000 VND"
    Khi MH Vay - Bước 2
    Và MH Vay - Bước 2 - Ngày trả nợ hàng tháng "15", mục đích vay "Mua thiết bị di động", tỉnh "TINH AN GIANG", huyện "THANH PHO LONG XUYEN"
    ...
    Và MH Vay - Bước 3 - họ và tên người vay "NGUYEN PHAM THUY DUNG"
    Khi Gửi yêu cầu vay
    ...
    Và Hồ sơ vay tiêu dùng cá nhân - Họ và tên ngươi vay "NGUYEN PHAM THUY DUNG"
    Và Hồ sơ vay tiêu dùng cá nhân - Email nhận hợp đồng "phuongangel85@gmail.com"

  Kịch bản: Thực hiện vay tiêu dùng bằng tài khoản nội bộ 711A57165998
    Cho Mở VTB iPayApp
    ...
    * MH Vay - Bước 1 - Số tiền phải trả hàng tháng mặc định "Từ 253,313 VND đến 289,750 VND"
    Khi MH Vay - Bước 2
    Và MH Vay - Bước 2 - Ngày trả nợ hàng tháng "15", mục đích vay "Mua thiết bị di động", email "nhungauto1@mailinator.com", tỉnh "TINH THAI BINH", huyện "THANH PHO THAI BINH"
    Thì MH Vay - Bước 3 - Số tiền vay "3,000,000 VND"
    Và MH Vay - Bước 3 - Thời hạn vay "12 tháng"
