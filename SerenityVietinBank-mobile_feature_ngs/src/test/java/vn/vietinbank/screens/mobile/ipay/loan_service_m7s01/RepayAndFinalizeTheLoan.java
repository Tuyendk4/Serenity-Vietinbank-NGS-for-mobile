...
public class RepayAndFinalizeTheLoan extends BaseScreen {
    ...
    private final String android_txtLoanAccountNumber = "//android.widget.EditText[@resource-id=\"com.vietinbank.mobile.ipay:id/edtContent\" and @text=\"Chọn khoản vay cần trả\"]";
    ...
    private final String android_iconAccountNumberSelection = "//android.widget.EditText[@resource-id=\"com.vietinbank.mobile.ipay:id/edtContent\" and @text=\"Chọn khoản vay cần trả\"]/following-sibling::android.widget.ImageView";

    private final String android_rdoRepayDebtPeriodically = "//android.widget.RadioButton[@resource-id=\"com.vietinbank.mobile.ipay:id/rad_period\" and @text=\"Trả nợ định kỳ\"]";
    private final String ios_rdoRepayDebtPeriodically = "//XCUIElementTypeButton[@name=\"Trả nợ định kỳ\"]";

    private final String android_rdoFinalSettlement = "//android.widget.RadioButton[@resource-id=\"com.vietinbank.mobile.ipay:id/rad_all\" and @text=\"Tất toán - đóng khoản vay\"]";
    private final String ios_rdoFinalSettlement = "//XCUIElementTypeButton[@name=\"Tất toán - đóng khoản vay\"]";

    private final String android_lblRepaymentSourceAccountNumber = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/lblFromAcc\" and @text=\"Tài khoản nguồn trả nợ\"]/following-sibling::android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvAccountNo\"]";
    ...
    private final String android_iconRepaymentSourceAccountNumberSelection = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/lblFromAcc\" and @text=\"Tài khoản nguồn trả nợ\"]/parent::android.widget.LinearLayout/following-sibling::android.widget.ImageView[@resource-id=\"com.vietinbank.mobile.ipay:id/ivSelect\"]";
    ...
    private final String android_lblAccountBalance = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/lblFromAcc\" and @text=\"Tài khoản nguồn trả nợ\"]/following-sibling::android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvAccountBalance\"]";
    ...
    private final String android_txtRepaymentMoney = "//android.widget.LinearLayout[@resource-id=\"com.vietinbank.mobile.ipay:id/wAmountWidget\"]//android.widget.EditText[@resource-id=\"com.vietinbank.mobile.ipay:id/edtContent\" and @text=\"Số tiền\"]";
    ...
    private final String android_txtNote = "//android.widget.LinearLayout[@resource-id=\"com.vietinbank.mobile.ipay:id/wRemark\"]//android.widget.EditText[@resource-id=\"com.vietinbank.mobile.ipay:id/edtContent\"]";
