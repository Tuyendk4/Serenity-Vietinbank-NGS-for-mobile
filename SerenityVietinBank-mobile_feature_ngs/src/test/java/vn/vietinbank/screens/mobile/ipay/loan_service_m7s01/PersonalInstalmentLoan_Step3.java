...
public class PersonalInstalmentLoan_Step3 extends BaseScreen {
  ...
  private final String android_lblNumberOfMoney = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvItemTitle\" and @text=\"Số tiền vay\"]/following-sibling::android.widget.TextView";
  ...
  private final String android_lblMonths = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvItemTitle\" and @text=\"Thời hạn vay\"]/following-sibling::android.widget.TextView";
  ...
  private final String android_lblInterestRate = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvItemTitle\" and @text=\"Lãi suất\"]/following-sibling::android.widget.TextView";
  ...
  private final String android_lblSpecialOffer = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvItemTitle\" and @text=\"Chương trình ưu đãi\"]/following-sibling::android.widget.TextView";
  ...
  private final String android_lblLoanPurpose = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvItemTitle\" and @text=\"Mục đích vay\"]/following-sibling::android.widget.TextView";
  ...
  private final String android_lblRepaymentDate = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvItemTitle\" and @text=\"Ngày trả nợ hàng tháng\"]/following-sibling::android.widget.TextView";
  ...
  private final String android_lblBorrowName = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvItemTitle\" and @text=\"Họ & tên người vay\"]/following-sibling::android.widget.TextView";
  ...
  private final String android_btnSend = "//android.widget.Button[@resource-id=\"com.vietinbank.mobile.ipay:id/btnNext\" and @text=\"Gửi yêu cầu vay\"]";
  private final String ios_btnSend = "//XCUIElementTypeButton[@name=\"Gửi yêu cầu vay\"]";

  private final String android_btnEdit = "//android.widget.Button[@resource-id=\"com.vietinbank.mobile.ipay:id/btnEdit\" and @text=\"Chỉnh sửa\"]";
  ...
  public void checkExactlyInformation() {
    if(appiumDriver instanceof AndroidDriver) {
      ...
      click("//android.widget.TextView[@text=\"Tôi xác nhận các thông tin trên là chính xác\"]/preceding-sibling::android.widget.CheckBox[@resource-id=\"com.vietinbank.mobile.ipay:id/cbValidInfo\"]");
    } else {
