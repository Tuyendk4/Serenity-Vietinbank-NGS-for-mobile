...
public class FavoriteServices extends BaseScreen {
    ...
    private final String ios_transfer = "//XCUIElementTypeStaticText[@name=\"Chuyển tiền\"]";
    private final String and_transfer = "(//android.widget.ImageView[@resource-id=\"com.vietinbank.ipay:id/ivProvider\"])[1]";
