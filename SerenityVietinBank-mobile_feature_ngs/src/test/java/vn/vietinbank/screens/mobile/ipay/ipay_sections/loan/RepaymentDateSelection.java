...
public class RepaymentDateSelection extends BaseScreen {
  ...
  public void chooseADate(String date) {
    ...
    if(appiumDriver instanceof AndroidDriver) {
      btnDates = findElements("//android.widget.TextView[@resource-id=\"com.vietinbank.ipay:id/title_text\" and @text=\"Chọn ngày trả nợ hàng tháng\"]/parent::android.widget.LinearLayout[@resource-id=\"com.vietinbank.ipay:id/liTitle\"]/following-sibling::androidx.recyclerview.widget.RecyclerView[@resource-id=\"com.vietinbank.ipay:id/rcv_day\"]//android.widget.TextView");
    } else {
