...
public class PersonalInstalmentLoan_Step1 extends BaseScreen {
    ...
    private final String android_txtNumberOfMoney = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvTitle\" and @text=\"Số tiền vay\"]/following-sibling::android.widget.LinearLayout/android.widget.EditText[@resource-id=\"com.vietinbank.mobile.ipay:id/edtContent\"]";
    ...
    private final String android_btnEditMoney = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvTitle\" and @text=\"Số tiền vay\"]/following-sibling::android.widget.LinearLayout/android.widget.ImageView[@resource-id=\"com.vietinbank.mobile.ipay:id/ivSelect\"]";
    ...
    private final String android_txtMonths = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvTitle\" and @text=\"Thời hạn vay\"]/following-sibling::android.widget.LinearLayout/android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/edtContent\"]";
    ...
    private final String android_btnEditMonths = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvTitle\" and @text=\"Thời hạn vay\"]/following-sibling::android.widget.LinearLayout/android.widget.ImageView[@resource-id=\"com.vietinbank.mobile.ipay:id/ivSelect\"]";
    ...
    private final String android_txtSearchMonth = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/title_text\" and @text=\"Thời hạn vay\"]/parent::android.widget.LinearLayout[@resource-id=\"com.vietinbank.mobile.ipay:id/view_header\"]/following-sibling::android.widget.LinearLayout//android.widget.EditText[@resource-id=\"com.vietinbank.mobile.ipay:id/edtFinter\"]";
    ...
    private final String android_lblInterestRate = "//android.widget.TextView[@text=\"Lãi suất\"]/following-sibling::android.widget.LinearLayout//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvRateCurrent\"]";
    ...
    private final String android_lblMonthlyChargeAmount01 = "//android.widget.TextView[contains(@text,\"Số tiền phải trả\")]/following-sibling::android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvTotalIntCurrent\"]";
    ...
    private final String android_chkInsuranceAgreement = "//android.widget.TextView[@text=\"Tôi xác nhận các thông tin trên là chính xác\"]/preceding-sibling::android.widget.CheckBox[@resource-id=\"com.vietinbank.mobile.ipay:id/cbValidInfo\"]";
    ...
    private final String android_chkTermsAndConditions = "//android.widget.TextView[@resource-id=\"com.vietinbank.mobile.ipay:id/tvTermAndService\"]/preceding-sibling::android.widget.CheckBox[@resource-id=\"com.vietinbank.mobile.ipay:id/cbTermAndService\"]";
