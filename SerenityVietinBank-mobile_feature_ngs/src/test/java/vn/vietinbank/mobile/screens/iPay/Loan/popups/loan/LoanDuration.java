  ...
  public void selectMonth(String month) {
    ...
    if(appiumDriver instanceof AndroidDriver) {
      lblMonth =  findElement(
          "//android.widget.TextView[@resource-id=\"com.vietinbank.ipay:id/title_text\" and @text=\"Thời hạn vay\"]/parent::android.widget.LinearLayout/following-sibling::android.widget.LinearLayout//android.widget.TextView[@resource-id=\"com.vietinbank.ipay:id/tvLeft\" and @text=\"" + month + "\"]");
    } else {
      lblMonth = findElement(
