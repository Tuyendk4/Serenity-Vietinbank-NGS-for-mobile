...
public class ScanQRScreen extends BaseScreen {
    ...
    public void chooseImageInAlbumByIndex(String index, String albumName) {
        swipeUpToAlbum();
        clickAlbumTxt();
        delay(3000);
        clickAlbumByNameTab();
    ...
    public void chooseImageInAlbumDefaultByIndex(String index) {
        swipeUpToAlbum();
        clickAlbumTxt();
        delay(3000);
    ...
    public void chooseImageQRInAlbumDefaultByIndex(String index) {
        swipeUpToAlbum();
        clickAlbumTxt();
        delay(3000);
        clickImageByIndex(index, null);
