...
import vn.vietinbank.mobile.screens.iPay.Transfer.Elements.TransferObroadElements;

import java.time.Duration;
import java.util.List;


public class TransferObroadScreen extends TransferObroadElements {
    String contentNote;

    public TransferObroadScreen(AppiumDriver appiumDriver) {
        super(appiumDriver);
    }
    ...
    public void choose_receiving_bank(String code_swift) {
        ...
        txt_swift_code.sendKeys(code_swift);
        txt_swift_name.click();
    ...
    @Step
    public void other_oversear_payment() {
        tap(txtPurpose);
