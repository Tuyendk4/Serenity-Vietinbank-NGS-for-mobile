...
import vn.vietinbank.mobile.screens.iPay.Gifts.Flowers.DateReceiveFlowersScreen;
import vn.vietinbank.mobile.screens.iPay.Gifts.Flowers.OrderFlowersScreen;

public class OrderFlowersSteps {
    ...
    DateReceiveFlowersScreen dateReceiveFlowersScreen = new DateReceiveFlowersScreen(appiumDriver);
    ...
    public void nhan_dat_mua_hoa_den_mh_xac_nhan_thanh_toan() {
        orderFlowersScreen.clickOrderFlowerBtn();
    }

    @And("chọn ngày nhận hoa ngẫu nhiên")
    public void chon_ngay_nhan_hoa_ngau_nhien() {
        orderFlowersScreen.clickDateReceiveFlowers();
        dateReceiveFlowersScreen.tapRandomDate();
    }
}
