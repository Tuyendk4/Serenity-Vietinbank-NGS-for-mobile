...
public class TransferMoneySteps {
    ...
    TransferMoneyScreen transferMoneyScreen = new TransferMoneyScreen(Serenity.sessionVariableCalled("appiumDriver"));
    ...
    public void den_mh_chuyen_ngoai_ht_sau_khi_chon_nguoi_thu_huong(String beneficiary) {
        transferMoneyScreen.chooseInListOfBeneficiariesOutside(beneficiary);
    }
    ...
    public void den_mh_chuyen_trong_ht_sau_khi_chon_nguoi_thu_huong(String beneficiary) {
        transferMoneyScreen.chooseInListOfBeneficiariesInside(beneficiary);
    }
