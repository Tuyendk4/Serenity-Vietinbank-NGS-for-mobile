...
import vn.vietinbank.mobile.screens.iPay.Transfer.ResultTransactionScreen;
...
public class ResultTransactionSteps {

    // objects
    Converter converter = new Converter();
    ResultTransactionScreen resultTransactionScreen = new ResultTransactionScreen(Serenity.sessionVariableCalled("appiumDriver"));
    ...
    public void quay_lai_home_tu_mh_ket_qua_gd() {
        resultTransactionScreen.backToHome();
    }
}
