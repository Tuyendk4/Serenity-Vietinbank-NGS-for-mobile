package vn.vietinbank.mobile.steps.iPay.Loan.LoanAndCreditServices;
...
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.CalculatorTool;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.InsuranceContractContent;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.LoanAndCreditServices;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.LoanContractContent;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.LoanHistory;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.LoanProfile;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.LoanProfileDetail;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.OnlineSecuredOverdraftLoan;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.OnlineSecuredOverdraft_LoanContractContent;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.Overdraft;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.Overdraft_LoanContractContent;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.Overdraft_LoanProfileDetail;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.Overdraft_SuccessfullyAppraisal;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.PersonalInstalmentLoan;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.PersonalInstalmentLoan_Step1;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.PersonalInstalmentLoan_Step2;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.PersonalInstalmentLoan_Step3;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.PersonalInstalmentLoan_SuccessfulApplicationAppraisal;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.ReferenceRepaymentSchedule;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.RepayAndFinalizeTheLoan;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.SecuredOverdraft;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.TransactionApproval;
import vn.vietinbank.mobile.screens.iPay.Loan.LoanAndCreditServices.TransactionResult;

public class LoanAndCreditServicesStepdefs {

  private final AppiumDriver appiumDriver = Serenity.sessionVariableCalled("appiumDriver");
  private LoanAndCreditServices loanAndCreditServices = new LoanAndCreditServices(appiumDriver);
  private HomeScreen home;
  private PersonalInstalmentLoan personalInstalmentLoan;
...
//      monthlyChargeAmount = monthlyChargeAmount.replaceFirst("VND", "");
  ...
  public void finalize_the_loan(String repayment_type,
    ...
    repayAndFinalizeTheLoan.choose_repayment_type(repayment_type);
    repayAndFinalizeTheLoan.input_loan_account_number(Serenity.sessionVariableCalled("newestAccountNumber"));
    repayAndFinalizeTheLoan.choose_repayment_source_account_number(repayment_source_account_number);
    transactionApproval = repayAndFinalizeTheLoan.click_Continue_button();
  }
  ...
  public void make_a_overdraft_loan_with(
    ...
    Overdraft_LoanProfileDetail overdraftLoanProfileDetail = overdraft.click_Continue_button();
    ...
    Overdraft_SuccessfullyAppraisal overdraftSuccessfullyAppraisal = overdraftLoanProfileDetail.click_Continue_button();
  ...
  public void make_a_secured_overdraft_loan_with(
    ...
    OnlineSecuredOverdraftLoan onlineSecuredOverdraftLoan = securedOverdraft.click_Continue_button();
    ...
    OnlineSecuredOverdraft_LoanContractContent onlineSecuredOverdraft_loanContractContent = onlineSecuredOverdraftLoan.click_Continue_button();
