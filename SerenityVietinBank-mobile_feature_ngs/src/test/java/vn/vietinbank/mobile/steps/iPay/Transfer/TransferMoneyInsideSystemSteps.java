...
public class TransferMoneyInsideSystemSteps {

    TransferMoneyInsideSystemScreen transferMoneyInsideSystemScreen = new TransferMoneyInsideSystemScreen(Serenity.sessionVariableCalled("appiumDriver"));
    ...
    public void nhan_tiep_tuc_tren_mh_chuyen_trong_ht_sau_khi_nhap_so_tien_den_mh_xac_nhan_gd() {
        transferMoneyInsideSystemScreen.clickContinueBtnAfterInputAmount();
    }

    @And("nhấn Tiếp tục trên MH Chuyển trong HT")
    public void nhan_tiep_tuc_tren_mh_chuyen_trong_ht() {
        transferMoneyInsideSystemScreen.clickContinueBtn();
    }
