package vn.vietinbank.mobile.steps.QRCodeGenerator;
...
public class QrCodeGeneratorSteps {
    ...
    QRCodeGeneratorScreen qrCodeGeneratorScreen = new QRCodeGeneratorScreen(Serenity.sessionVariableCalled("appiumDriver"));
