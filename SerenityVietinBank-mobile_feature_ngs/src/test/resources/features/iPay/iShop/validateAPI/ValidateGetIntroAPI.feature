@ValidateGetIntroAPI
Feature: Validate Get Intro API

  @TC001
  Scenario Outline: Validate Get Intro API: <testCase>
    Given tạo headers request mặc định
    When lấy "BODY_REQUEST" từ file json "iPay/iShop/getIntro.json"
    And cập nhật lại json "BODY_REQUEST"
      | <field> |
      | <value> |
    And gọi api "iShop.shop.getIntro" với phương thức "POST"
