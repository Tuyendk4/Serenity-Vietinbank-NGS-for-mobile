@ValidateGetIncomeAPI
Feature: Validate Get Income API

  @TC001
  Scenario Outline: Validate Get Income API: <testCase>
    ...
    Examples:
      ...
      | Call success             | shopId     | GIAU6NFYPY       | 200       | SUCCESS                                     |
      ...
      | PeriodType_null          | periodType | NULL             | 90        | Dữ liệu không hợp lệ. Xin vui lòng thử lại. |
      | PeriodType_blank         | periodType | BLANK            | 90        | Dữ liệu không hợp lệ. Xin vui lòng thử lại. |
      | PeriodType_overMaxLength | periodType | RANDOM_STRING_11 | 90        | Dữ liệu không hợp lệ. Xin vui lòng thử lại. |
      | PeriodType_remove        | periodType | REMOVE           | 90        | Dữ liệu không hợp lệ. Xin vui lòng thử lại. |