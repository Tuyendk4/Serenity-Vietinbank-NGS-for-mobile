@ValidateInitSoftOtpShareShopAPI
Feature: Validate Init Soft Otp Share Shop API

  @TC001
  Scenario Outline: Validate Init Soft Otp Share Shop API: <testCase>
    Given tạo headers request mặc định
    When lấy "BODY_REQUEST" từ file json "iPay/iShop/sendSmsOTP.json"
    ...
    Examples:
      ...
      | RequestId_null          | requestId  | NULL             | 500       | Internal Server Error                       |
      | RequestId_blank         | requestId  | BLANK            | 500       | Internal Server Error                       |
      | RequestId_remove        | requestId  | REMOVE           | 500       | Internal Server Error                       |
