@flow1 @loan11
Feature: 11 - Vay tiêu dùng cá nhân - Hub giải ngân thành công - Không bảo hiểm

  Scenario Outline: Thực hiện tạo vay tiêu dùng không ưu đãi thông qua tính toán khoản vay thành công bằng tài khoản hub
    ...
    * MH Vay - Bước 1 - Số tiền phải trả hàng tháng mặc định "<monthly_charge_amount>"
    ...
    Then Thông báo "Quý khách cần trợ giúp thêm xin liên hệ 1900558868"
    ...
    And Thẩm định hồ sơ thành công - Lãi suất "<interest_rate>"
    ...
    Examples:
      | user_name  | password | otp_code | number_of_money | number_of_months | edit_type | interest_rate | monthly_charge_amount          | interest_payable_total | principal_and_interest_payable_total | repayment_date | loan_purpose         | receive_email             | province      | district             | full_format_number_of_money | full_format_number_of_money_02 | full_format_number_of_months | borrow_full_name | loan_status   |
      | nhungauto4 | 12121212 | 888888   | 3000000         | 12               | EditText  | 15.9%/năm     | Từ 253,313 VND đến 289,750 VND | 258,378 VND            | 3,258,378 VND                        | 15             | Mua thiết bị di động | nhungauto4@mailinator.com | TINH AN GIANG | THANH PHO LONG XUYEN | 3,000,000 VND               | 3.000.000 VNĐ                  | 12 tháng                     | CUSTOMER NAME    | Chờ thẩm định |