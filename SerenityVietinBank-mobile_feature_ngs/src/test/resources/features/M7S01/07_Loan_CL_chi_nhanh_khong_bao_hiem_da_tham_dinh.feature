@CLCNTDKBHFlow @flow1 @loan07
Feature: 07 - Vay tiêu dùng cá nhân - Chi nhánh giải ngân thành công - Không bảo hiểm

  Scenario Outline: Thực hiện tạo vay tiêu dùng không ưu đãi thông qua tính toán khoản vay thành công bằng tài khoản chi nhánh
    ...
    * MH Vay - Bước 1 - Số tiền phải trả hàng tháng mặc định "<monthly_charge_amount>"
    ...
    Then MH Danh sách tài khoản - Hiển thị khoản vay mới nhất với số tiền "Dư nợ hiện tại: <full_format_number_of_money>"
    ...
    Examples:
      ...
      | nhungauto1 | 12121212 | 888888   | 3000000         | 12               | EditText  | 15.9%/năm     | Từ 253,313 VND đến 289,750 VND | 258,378 VND            | 3,258,378 VND                        | 15             | Mua thiết bị di động | nhungauto4@mailinator.com | TINH AN GIANG | THANH PHO LONG XUYEN | 3,000,000 VND               | 3.000.000 VNĐ                  | 12 tháng                     | CUSTOMER NAME    |