@flow1 @loan08
Feature: 08 - Vay tiêu dùng cá nhân - Chi nhánh giải ngân thành công - Có bảo hiểm

  Scenario Outline: Thực hiện tạo vay tiêu dùng có ưu đãi thông qua tính toán khoản vay thành công bằng tài khoản chi nhánh
    ...
    * MH Vay - Bước 1 - Số tiền phải trả hàng tháng mặc định "<monthly_charge_amount>"
    ...
    Examples:
      ...
      | nguyentrungviet1993 | 12121212 | 888888   | 3000000         | 12               | EditText  | 13.9%/năm     | Từ 252,896 VND đến 284,750 VND | 225,876 VND            | 3,225,876 VND                        | 15             | Mua thiết bị di động | nhungauto4@mailinator.com | TINH AN GIANG | THANH PHO LONG XUYEN | 3,000,000 VND               | 3.000.000 VND                  | 12 tháng                     | CUSTOMER NAME    |