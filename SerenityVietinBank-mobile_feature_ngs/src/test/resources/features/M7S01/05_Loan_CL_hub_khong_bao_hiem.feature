@CLHUBKBHFlow
Feature: M7S01 - Vay tiêu dùng cá nhân - Hub - Không bảo hiểm
  ...
  Scenario Outline: Vay tiêu dùng không bảo hiểm bằng tài khoản hub
    ...
    * Thông báo "Quý khách cần trợ giúp thêm xin liên hệ 1900558868"
    ...
    Examples:
      ...
      | nhungauto1 | 12121212 | 888888   | 3000000         | 12               | EditText  | 15.9%/năm     | Từ 253,313 VND đến 289,750 VND | 258,378 VND            | 3,258,378 VND                        | 15             | Mua thiết bị di động | nhungauto4@mailinator.com | TINH AN GIANG | THANH PHO LONG XUYEN | 3,000,000 VND               | 12 tháng                     | CUSTOMER NAME    | Chờ thẩm định | Mua thiet bi di dong  |
