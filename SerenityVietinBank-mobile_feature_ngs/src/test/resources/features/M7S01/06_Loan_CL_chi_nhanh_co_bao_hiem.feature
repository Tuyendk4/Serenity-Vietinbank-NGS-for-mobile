@CLCNCBHFlow @flow1 @loan06
Feature: 06 - Vay tiêu dùng cá nhân - Chi nhánh - Có bảo hiểm
  ...
  Scenario Outline: Vay tiêu dùng không bảo hiểm bằng tài khoản chi nhánh
    ...
    * MH Vay - Bước 1 - Số tiền phải trả hàng tháng mặc định "<monthly_charge_amount>"
    ...
    Examples:
      ...
      | n.thithuy | 12121212 | 888888   | 3000000         | 12               | EditText  | 13.9%/năm     | Từ 252,896 VND đến 284,750 VND | 225,876 VND            | 3,225,876 VND                        | 15             | Mua thiết bị di động | nhungauto4@mailinator.com | TINH AN GIANG | THANH PHO LONG XUYEN | 3,000,000 VND               | 12 tháng                     | CUSTOMER NAME    | Chờ thẩm định | Mua thiet bi di dong  |

  Scenario Outline: Xóa khoản vay tiêu dùng có bảo hiểm bằng tài khoản chi nhánh
    Given Mở VTB iPayApp
    When Đăng nhập user "<user_name>", password "<password>", otp "<otp_code>"
    ...
    * MH Vay tiêu dùng cá nhân - Hủy khoản vay
    ...
    Examples:
      ...
      | n.thithuy | 12121212 | 888888   | Chờ thẩm định | 3,000,000.00 VND            |