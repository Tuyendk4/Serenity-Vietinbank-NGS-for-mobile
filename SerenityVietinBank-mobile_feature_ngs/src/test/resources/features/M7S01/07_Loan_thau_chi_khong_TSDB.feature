@TCKTSDBFlow
Feature: Vay Thấu chi không tài sản đảm bảo
  ...
  Scenario Outline: Thực hiện khoản vay Thấu chi không tài sản đảm bảo
    ...
    Then Kết quả giao dịch - hiển thị "Chúc mừng quý Khách đã được cấp hạn mức thấu chi.\r Quý khách có thể sử dụng hạn mức thấu chi trong tài khoản ngay sau khi nhận được thông báo qua số điện thoại & email"

    Examples:
      | user_name | password | otp_code | number_of_money | loan_duration | repayment_date | loan_purpose                      | receive_email         | province | district    |
      | tritu8284 | 12121212 | 888888   | 3000000         | 5 tháng       | 15             | Phục vụ nhu cầu đời sống gia đình | vitest@mailinator.com | HA NOI   | QUAN TAY HO |