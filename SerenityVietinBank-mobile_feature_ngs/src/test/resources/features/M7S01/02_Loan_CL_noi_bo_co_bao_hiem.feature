@CLNBCBHFlow @flow1 @loan02
Feature: 02 - Vay tiêu dùng cá nhân - Nội bộ - Có bảo hiểm

  Scenario Outline: Thực hiện tạo vay tiêu dùng có ưu đãi thông qua tính toán khoản vay bằng tài khoản nội bộ
    ...
    * MH Vay - Bước 1 - Số tiền phải trả hàng tháng mặc định "<monthly_charge_amount>"
    ...
    And MH Vay - Bước 3 - Chương trình ưu đãi là "VietinCare"
  ...
  Scenario Outline: Xóa khoản vay tiêu dùng có bảo hiểm bằng tài khoản nội bộ
    Given Mở VTB iPayApp
    When Đăng nhập user "<user_name>", password "<password>", otp "<otp_code>"
