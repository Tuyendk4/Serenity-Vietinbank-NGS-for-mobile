# language: vi
@flow2
Tính năng: M7S01 - Vay tiêu dùng cá nhân - Chi nhánh
  Kịch bản: Thực hiện tạo khoản vay tiêu dùng bằng tài khoản chi nhánh
    Cho Mở VTB iPayApp
    Khi Đăng nhập user "nhungauto4", password "12121212"
    ...
    * Lịch trả nợ - Số tiền phải trả hàng tháng "Từ 253,313 VND đến 289,750 VND"
    ...
    * MH Vay - Bước 1 - Số tiền phải trả hàng tháng mặc định "Từ 253,313 VND đến 289,750 VND"
    Khi MH Vay - Bước 2
    Và MH Vay - Bước 2 - Ngày trả nợ hàng tháng "15", mục đích vay "Mua thiết bị di động", email "nhungauto4@mailinator.com", tỉnh "TINH AN GIANG", huyện "THANH PHO LONG XUYEN"
    ...
    Và Hồ sơ vay tiêu dùng cá nhân - Mục đích vay "Mua thiet bi di dong"
    Và Hồ sơ vay tiêu dùng cá nhân - Họ và tên ngươi vay "CUSTOMER NAME"
    Và Hồ sơ vay tiêu dùng cá nhân - Email nhận hợp đồng "nhungauto4@mailinator.com"

  Kịch bản: Thực hiện xóa khoản vay tiêu dùng bằng tài khoản chi nhánh
    Cho Mở VTB iPayApp
    Khi Đăng nhập user "nhungauto4", password "12121212"
    * Menu Dịch vụ vay và tín dụng
    * Vào MH Lịch sử vay
    * Vào MH Vay tiêu dùng cá nhân của khoản vay "Chờ thẩm định"
    * MH Vay tiêu dùng cá nhân - Hủy khoản vay
    Thì MH Vay tiêu dùng cá nhân - Thông báo "Quý khách có chắc chắn muốn hủy hồ sơ vay?"
    Khi MH Vay tiêu dùng cá nhân - Xác nhận hủy
    Thì MH Vay tiêu dùng cá nhân - Thông báo thành công: "Yêu cầu vay 3,000,000.00 VND để phục vụ mục đích Mua thiet bi di dong đã được hủy thành công. Xin vui lòng gửi lại yêu cầu vay mới phù hợp hơn với nhu cầu của Quý khách"